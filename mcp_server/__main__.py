...
class Toolbox:
    ...
    def __init__(self, repo: Path):
        ...
        self.tools = {
            ...
            "validate_ficha": lambda **kw: toolbox_module.validate_ficha_tool(self.repo, **kw),
            "propose_ficha_correction": lambda **kw: toolbox_module.propose_ficha_correction(self.repo, **kw),
