...
- `content/` — as fichas, coleções e assets do seu acervo (a fonte de verdade curatorial);
...
cada ficha contra o contrato, aplica o gating de publicação e de tier, e emite o site
...
1. Crie `content/<colecao>/<nome-da-peca>/ficha.json` seguindo o contrato
...
4. Push. Se uma ficha estiver fora do contrato, **o build falha** e o site anterior
   continua no ar.
